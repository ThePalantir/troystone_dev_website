...
export default function Home() {
  ...
  return <>
    ...
    <footer><a className="wordmark" href="#top" aria-label="Troy Stone, back to top"><Image className="brand-mark" src="/ts-initials.png" alt="" width={64} height={48} /></a><p>Enterprise architecture · Automation · Intelligent systems</p><div className="footer-links"><span className="built-by"><strong>Built by</strong> <a className="truecore-link" href="https://truecore.services/" target="_blank" rel="noreferrer"><Image className="truecore-logo" src="/truecore-logo.png" alt="" width={24} height={18} /><strong>truecore.services</strong></a></span><a className="linkedin-link" href="https://www.linkedin.com/in/troystone" aria-label="LinkedIn">in</a></div></footer>
