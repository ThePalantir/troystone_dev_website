...
export default function Home() {
  const jsonLd = { "@context": "https://schema.org", "@type": "Person", name: "Troy Stone", url: "https://www.troystone.dev", jobTitle: "Enterprise Systems Architect", sameAs: [siteLinks.linkedIn], knowsAbout: ["Enterprise Architecture", "Power Platform", "Microsoft Graph", "Automation", "Agentic AI"] };
  return <>
