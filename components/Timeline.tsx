...
const eras = [
  ...
  { year: "2010s", label: "Cloud platforms", note: "Microsoft shifted the center of gravity from owned infrastructure to connected services. The cloud replaced step-function CapEx growth with a continuous dial. Infrastructure no longer had to be purchased years in advance. Capacity could expand or contract with the needs of the business." },
